...
@pytest.mark.parametrize(
    "n_clicks, custom_analysis_name, region, year, occupation, current_data, current_menu_items, expected_output",
    [
        # Test case 1: Save a new analysis with a custom name
        (
            1, "Test Analysis", "Scotland", 2021, "1", [], [],
            (
                [dbc.DropdownMenuItem(children='Test Analysis', id={'type': 'saved-analysis', 'index': 0}, n_clicks=0)],
                [
                    {
                        "name": "Test Analysis",
                        "region": "Scotland",
        ...
        (1, "", "England", 2023, "3", [], [], (
            [dbc.DropdownMenuItem(children='Analysis 1: England, 2023', id={'type': 'saved-analysis', 'index': 0}, n_clicks=0)],
            [{"name": "Analysis 1: England, 2023", "region": "England", "year": 2023, "occupation": "3"}],
            False,
            no_update
        )),

        # Test case 3: Prevent saving an analysis without selecting a region and year
        (1, "", "", 2021, "1", [], [], (
            no_update,
            no_update,
            True,
        ...
        (1, "Test Analysis", "Scotland", 2021, "1", [
            {"name": "Test Analysis", "region": "Scotland", "year": 2021, "occupation": "1"}
        ], [
            {"type": "saved-analysis", "index": 0, "children": "Test Analysis"}
        ], (
            no_update,
            no_update,
            True,
            "An analysis named 'Test Analysis' already exists. Please choose a different name."
        )),

        # Test case 5: Prevent saving an analysis without clicking the save button
        (0, "", "", "", "", "", [], (
            PreventUpdate,
            PreventUpdate,
            PreventUpdate,
        ...
        if n_clicks == 0:
            ...
            if isinstance(expected_output, tuple):
                ...
                if expected_menu_items == no_update: 
                    ...
                    for output_item, expected_item in zip(output_menu_items, expected_menu_items):
